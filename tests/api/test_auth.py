...
class TestJWTAuthService:
    ...
    def test_verify_expired_token(self):
        ...
        with patch("api.services.auth.PyJWKClient") as mock_jwk_client_class:
            ...
            with patch("api.services.auth.jwt.decode", side_effect=jwt.ExpiredSignatureError()):
                service = JWTAuthService()
    ...
    def test_verify_wrong_audience_token(self):
        ...
        with patch("api.services.auth.PyJWKClient") as mock_jwk_client_class:
            ...
            with patch("api.services.auth.jwt.decode", side_effect=jwt.InvalidAudienceError()):
                service = JWTAuthService()
