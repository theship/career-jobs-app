...
async def test_skill_extraction_fuzzy_matching(resume_processor, sample_resume_text):
    ...
    resume_processor.skills_vocab = {
        'python': {'canonical': 'Python', 'category': 'Languages', 'aliases': ['py'], 'tags': []},
        'javascript': {'canonical': 'JavaScript', 'category': 'Languages', 'aliases': ['js'], 'tags': []},
        'react': {'canonical': 'React', 'category': 'Frameworks', 'aliases': [], 'tags': []},
        'docker': {'canonical': 'Docker', 'category': 'DevOps', 'aliases': [], 'tags': []},
        'kubernetes': {'canonical': 'Kubernetes', 'category': 'DevOps', 'aliases': ['k8s'], 'tags': []},
        'machine learning': {'canonical': 'Machine Learning', 'category': 'AI', 'aliases': ['ml'], 'tags': []},
        'pytorch': {'canonical': 'PyTorch', 'category': 'AI', 'aliases': [], 'tags': []},
        'fastapi': {'canonical': 'FastAPI', 'category': 'Frameworks', 'aliases': [], 'tags': []},
        'ci/cd': {'canonical': 'CI/CD', 'category': 'DevOps', 'aliases': [], 'tags': []},
        'agile': {'canonical': 'Agile', 'category': 'Methodology', 'aliases': [], 'tags': []},
    }
...
async def test_generate_embedding(resume_processor):
    ...
    with patch.object(resume_processor.openai_client.embeddings, 'create') as mock_create:
        mock_response = Mock()
...
async def test_multi_stage_pipeline_integration(resume_processor, sample_resume_text):
    ...
    # Mock OpenAI calls
    with patch.object(resume_processor.openai_client.embeddings, 'create') as mock_embed:
        with patch.object(resume_processor.openai_client.chat.completions, 'create') as mock_chat:
            ...
            # Set up vocabulary
            resume_processor.skills_vocab = {
                'python': {'canonical': 'Python', 'category': 'Languages', 'aliases': [], 'tags': []},
            }
